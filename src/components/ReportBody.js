    ...
    render() {
        if (this.props.reportType === 'Whois') {
            try {
                return (
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <p>Last Modification
                                    Date: {this.getDateStringFromEpoch(this.props.fullReport.attributes.last_modification_date)}</p>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                                <p>Last HTTPS Certificate
                                    Date: {this.getDateStringFromEpoch(this.props.fullReport.attributes.last_https_certificate_date)}</p>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                ...
                alert('Something went wrong with the Whois report. Skipping for now.')
            }
            ...
            try {
                ...
                console.log(JSON.stringify(err))
                alert('Something went wrong with the Geodata report. Skipping for now.')
            }
            ...
            try {
                return (
                    <Container fluid>
                        ...
                        <Row>
                            <Col>
                                <p>Number of Downloaded Samples (Both detected and
                                    undetected): {this.props.fullReport.undetected_downloaded_samples.length + this.props.fullReport.detected_downloaded_samples.length}</p>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
                ...
                console.log(JSON.stringify(err))
                alert('Something went wrong with the Virus Total report. Skipping for now.')
            }
        }
        return(
            <Container>
                <Row>
                    <Col>
                        <p>An error occurred. This report is not available at this time.</p>
                    </Col>
                </Row>
            </Container>
        )
